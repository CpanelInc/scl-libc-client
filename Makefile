...
# the primary project that contains the package you're modifying
OBS_PROJECT := EA4
...
ifdef SCL_TARGET
# Allow developer to build specific packages in the SCL, instead of all of them
SCL_TARGETS := $(SCL_TARGET)
else
# Autogenerated target names for an SCL package
SCL_TARGETS := $(shell ls -1 macros/ 2>/dev/null)
endif
